...
public interface BillInfoEntityMapper {
    ...
    @Mapping(target = "billPeriodFrom", expression = "java(LocalDate.parse(inv.getInvoicePeriod().getStartDate()))")
    @Mapping(target = "billPeriodTill", expression = "java(LocalDate.parse(inv.getInvoicePeriod().getEndDate()))")
