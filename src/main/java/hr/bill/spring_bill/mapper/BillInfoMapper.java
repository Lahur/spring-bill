...
import hr.bill.spring_bill.dto.web.bill.info.*;
...
public interface BillInfoMapper {
    ...
    @Mapping(target = "billPeriodFrom", expression = "java(inv.getInvoicePeriod() != null && inv.getInvoicePeriod().getStartDate() != null ? LocalDate.parse(inv.getInvoicePeriod().getStartDate()) : null)")
    @Mapping(target = "billPeriodTill", expression = "java(inv.getInvoicePeriod() != null && inv.getInvoicePeriod().getEndDate() != null ? LocalDate.parse(inv.getInvoicePeriod().getEndDate()) : null)")
