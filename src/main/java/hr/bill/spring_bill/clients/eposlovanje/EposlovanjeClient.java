...
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.EReportingRequestsResponse;
...
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.request.AccountApiKeyRequest;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.request.AccountRegistrationRequest;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.request.AccountTransferPrepaidFundsRequest;
...
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.request.DocumentValidateRequest;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.request.EReportingDocumentPaidRequest;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.request.EReportingDocumentRejectedRequest;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.request.EReportingReportDocumentRequest;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.AccountApiKeyResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.AccountBalanceResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.AccountRegistrationResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.AccountTransferPrepaidFundsResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.AmsCheckResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.BankingAccount;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.BankingTransaction;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.BusinessUnit;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.DocumentChangeStatusResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.DocumentGetResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.DocumentSendResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.DocumentStatusResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.DocumentValidateResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.DocumentVisualizationResponse;
import hr.bill.spring_bill.dto.eposlovanje.eposlovanje.response.EReportingReportDocumentResponse;
